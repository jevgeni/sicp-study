...
;; experiments show, that Eva is right. The reason the tolerance is better, when there are no repeated variable is that each time you miltiple or divide the intervals, the tolerance increases. Therefore, it is better to reduce the number of operations to keep the tolerance low.
